...
import static iit.alaurent1.knowyourgovernment.R.id.googleplus;
import static iit.alaurent1.knowyourgovernment.R.id.location;
import static iit.alaurent1.knowyourgovernment.R.id.official_address;
import static iit.alaurent1.knowyourgovernment.R.id.official_email;
import static iit.alaurent1.knowyourgovernment.R.id.official_party;
import static iit.alaurent1.knowyourgovernment.R.id.official_phone;
import static iit.alaurent1.knowyourgovernment.R.id.official_website;
    ...
    private void loadPhoto(){
        ...
        if (official.getPhotoURL() != null && !official.getPhotoURL().isEmpty()) {
                    ...
                    .listener(new Picasso.Listener() {
                        ...
                        public void onImageLoadFailed(Picasso picasso, Uri uri, Exception exception) {
                            ...
                            picasso.load(changedUrl)
                                    .error(R.drawable.img_brokenimage)
            ...
            Picasso. with(this).load((String) null)
                    .error(R.drawable.img_brokenimage)
                    .placeholder(R.drawable.img_missingimage)
                    .into(official_photo);
