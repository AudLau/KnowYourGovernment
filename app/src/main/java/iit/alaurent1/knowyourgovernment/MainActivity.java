package iit.alaurent1.knowyourgovernment;
 ...
 *  Assignment 5
 *
 *  Aude Laurent - alaurent1 - A20387679
 *
 *  ***
 *
 *  This application present the civic representatives of a location (geolocalisation or choose by the user)
 *  The project contains 9 classes:
 *      - Main Activity: Handle the main interface that show the notes
 *      - Official: The java class handling an representative
 *      - OfficialViewHandler: Link the layout with the OfficialAdapter
 *      - OfficialAdapter: Handle the list in the recycler view
 *      - CivicInfoFownloader: The asyncTask downloading the representatives information based on a location
 *      - Locator: Handle the location finder
 *      - OfficialActivity: Handle the Activity presenting a representative
 *      - PhotoActivity: Handle the activity zooming on the photo
 *      - AboutActivity: Handle the credit's activity
 *
 *
 *  It has been optimized for devices running on API higher or equal to API 16 (Jelly Bean)
 *  It has been tested on a real device on API 24 (Nougat)
 *
 *******/
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnLongClickListener {
                        ...
                        try {
                            ...
                            Log.e(TAG, "addresses:"+addresses);
                                ...
                                if (addresses.get(0)!=null ) {
                                    CivicInfoDownloader cidl = new CivicInfoDownloader(MainActivity.this);
    ...
    public void doLocationWork(double latitude, double longitude) {
        ...
        try {
            ...
            if (addresses.get(0) !=null ) {
                CivicInfoDownloader cidl = new CivicInfoDownloader(this);
                if(addresses.get(0).getPostalCode() != null)
                    cidl.execute(addresses.get(0).getPostalCode());
                else
                    cidl.execute(addresses.get(0).getAddressLine(0));
    ...
    //Check wether te connection is on and return it as a boolean
